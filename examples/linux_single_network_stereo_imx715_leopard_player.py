...
class HoloscanApplication(holoscan.core.Application):
    ...
    def compose(self):
        ...
        test_offset = 50 * received_line_bytes
        self._camera_left.configure_converter(
            csi_to_bayer_operator_left, start_byte_offset=test_offset
        )
        ...
        self._camera_right.configure_converter(
            csi_to_bayer_operator_right, start_byte_offset=test_offset
        )
...
def main():
    ...
    camera_left = hololink_module.sensors.imx715lp.Imx715Cam(
        hololink_channel_left,
        expander_configuration=0,
    )
    camera_right = hololink_module.sensors.imx715lp.Imx715Cam(
        hololink_channel_right,
    ...
    try:
        ...
        proc.terminate()
        # camera_left.setup_clock()  # this also sets camera_right's clock, currently disabled
