...
class HoloscanApplication(holoscan.core.Application):
    ...
    def setup_sequencer(self):
        ...
        # GPIO Pin 0 will be set HIGH on Frame Start event with a delay
        ...
        sequencer.write_uint32(GPIO_DELAY_REG, 0x6978)  # 27ms delay
...
def main():
    ...
    if not infiniband_devices:
        raise RuntimeError(
            "No InfiniBand devices available; this example requires IB support."
        )
