...
class PostprocessorOp(Operator):
    ...
    def compute(self, op_input, op_output, context):
        ...
        out_message = {
            ...
            "image": hs.as_tensor(output_image),
        }
...
class DepthAnythingV2App(Application):
    def __init__(self, data, source="v4l2", video_device="none"):
        ...
        if data == "none":
            data = os.path.join(
                os.environ.get("HOLOHUB_DATA_PATH", "../data"), "depth_anything_v2"
            )
...
def main():
    ...
    parser.add_argument(
        ...
        default="none",
        help=(
            "The video device to use.  By default the application will use /dev/video0"
        ),
    )
